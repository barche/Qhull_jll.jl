...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Qhull_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("784f63db-0788-585a-bace-daefebcd302b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Qhull", artifacts_toml) for e in artifacts["Qhull"]]
...
if best_platform === nothing
    @debug("Unable to load Qhull; unsupported platform $(triplet(platform_key_abi()))")
else
