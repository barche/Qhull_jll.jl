# Autogenerated wrapper script for Qhull_jll for x86_64-apple-darwin14
...
const libqhull_r_splitpath = ["lib", "libqhull_r.7.3.2.dylib"]
...
const libqhull_r = "@rpath/libqhull_r.7.dylib"
