# Autogenerated wrapper script for Qhull_jll for x86_64-w64-mingw32
...
const qvoronoi_splitpath = ["bin", "qvoronoi.exe"]
...
const qconvex_splitpath = ["bin", "qconvex.exe"]
...
const libqhull_r_splitpath = ["bin", "libqhull_r.dll"]
...
const libqhull_r = "libqhull_r.dll"


# Relative path to `qhull`
const qhull_splitpath = ["bin", "qhull.exe"]
...
const qhalf_splitpath = ["bin", "qhalf.exe"]
...
const rbox_splitpath = ["bin", "rbox.exe"]
...
const qdelaunay_splitpath = ["bin", "qdelaunay.exe"]
